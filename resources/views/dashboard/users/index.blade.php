...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <div class="table-responsive">
    <a href="/dashboard/users/create" class="btn btn-primary mb-3">Add User</a>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="/dashboard/users/{{ $user->id }}" title="Read" class="badge bg-info"><i class="bi bi-eye-fill" style="font-size: 20px;"></i></a>
            <a href="/dashboard/users/{{ $user->id }}/edit" title="Update" class="badge bg-warning"><i class="bi bi-pencil-square" style="font-size: 20px;"></i></a>
